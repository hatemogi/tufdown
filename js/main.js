...
ya?xa(a):wa.call(null,a))}a.N=0;a.J=function(a){a=J(a);return b(a)};a.B=b;return a}(),Ce=new Worker("js/worker.js");Ce.onmessage=function(a){a=a.data;console.log(a.time);return document.getElementById("preview").contentWindow.replace_article.call(null,a.html)};if("undefined"===typeof De)var De=Ce;
